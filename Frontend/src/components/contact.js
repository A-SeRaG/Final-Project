    ...
    <Container className="contact">
      ...
      <Row>
        ...
        <Col md={4}>
          <div className="text1">
            <h3>
              <FontAwesomeIcon icon="fa-solid fa-phone" /> Call To Us
            </h3>
          ...
          <div className="text2">
            <h3>
              {" "}
              <FontAwesomeIcon icon="fa-regular fa-envelope" /> Write To US
            </h3>
        ...
        <Col md={6}>
          <Row>
            <Col xs={6} md={4}>
              <Form.Control
                style={{ backgroundColor: " rgb(247, 239, 239)" }}
          ...
          <Row>
            <Form style={{ marginTop: "50px" }}>
              ...
              <Button
                style={{ backgroundColor: "var(--second-color)", width: "50%" }}
              >
                send message
              </Button>
            </Form>
