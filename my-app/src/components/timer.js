      ...
      <div className="parent-timer">
        <div className="timer-container">
          ...
          <div className="timer">
            ...
            <div className="time-block">
              <span id="hours">{String(timeElapsed.hours).padStart(2, "0")}</span>
              <p>Hours:</p>
            </div>
            <div className="time-block">
              <span id="minutes">{String(timeElapsed.minutes).padStart(2, "0")}</span>
              <p>Minutes:</p>
            </div>
            <div className="time-block">
              <span id="seconds">{String(timeElapsed.seconds).padStart(2, "0")}</span>
              <p>Seconds:</p>
            </div>
          </div>
        </div>
